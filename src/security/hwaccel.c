...
#define HWACCEL_MAX_DEVICES 16
#define HWACCEL_TYPE_NONE 0
#define HWACCEL_TYPE_CRYPTO 1
#define HWACCEL_TYPE_COMPRESS 2
#define HWACCEL_TYPE_NETWORK 3
#define HWACCEL_TYPE_CSUM 4
#define HWACCEL_TYPE_TSO 5
#define HWACCEL_TYPE_GSO 6
#define HWACCEL_TYPE_RSS 7
#define HWACCEL_TYPE_INTEL_AES_NI 8
#define HWACCEL_TYPE_ARM_CE 9

typedef int hwaccel_type_t;
