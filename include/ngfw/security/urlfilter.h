...
#ifndef NGFW_SECURITY_URLFILTER_H
#define NGFW_SECURITY_URLFILTER_H

#include "ngfw/types.h"

/*
 * URL Filtering
 * Domain and URL-based filtering with category support
 */
...
/* Domain suffix tree for fast matching */
typedef struct domain_suffix_tree {
    struct domain_suffix_tree *children[27];  /* a-z + wildcard */
    url_category_t category;
    bool is_end;
